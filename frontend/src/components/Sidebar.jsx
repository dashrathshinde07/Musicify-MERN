  ...
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white  lg:flex">
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 bg-[#212124] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4">
        ...
        <div className="p-4 bg-[#212124] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4">
